...
// CSV template header
const CSV_TEMPLATE =
    `registration_no,make,model,year,chassis_no,engine_no,body_type_id,category_id,vehicle_type_id,seating_capacity,cubic_capacity,gross_weight
UBC123D,Toyota,Corolla,2022,JTDZS3EU0E3298500,2ZR-3298500,body_type_id_here,category_id_here,vehicle_type_id_here,5,1800,1500
